          ...
          <div class="card shadow">
            ...
            <div class="table-responsive">
              <form class="form-inline mb-3" method="get">
                <input type="text" name="search" class="form-control mr-2" placeholder="Search name/code"
                  ...
                  if ($res && $res->num_rows > 0) {
                    while ($prod = $res->fetch_object()) {
                      ...
                      <tr>
                        ...
                        <td><?php echo $prod->category ? htmlspecialchars($prod->category) : 'Uncategorized'; ?></td>
