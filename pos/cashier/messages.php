...
// Get all customers and admin for recipient list
$recipients_query = "SELECT 'customer' as type, customer_id as id, customer_name as name, customer_email as email FROM rpos_customers 
                     UNION 
                     SELECT 'admin' as type, admin_id as id, admin_name as name, admin_email as email FROM rpos_admin";
    ...
    <script>
        ...
        function displayMessages(messages) {
            ...
            messages.forEach(function (msg) {
                const isOwn = msg.sender_id === '<?php echo $staff_number; ?>' && msg.sender_type === 'staff';
                const messageHtml = `
