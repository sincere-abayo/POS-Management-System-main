                ...
                <form method="POST" enctype="multipart/form-data">
                  <div class="form-row">
                    <div class="col-md-6">
                      ...
                      <input type="text" value="<?php echo $prod->prod_name; ?>" name="prod_name" class="form-control<?php if (isset($missing_fields) && in_array('prod_name', $missing_fields))
                           echo ' is-invalid'; ?>">
                    </div>
                    <div class="col-md-6">
                      <label>Product Code</label>
                      <input type="text" name="prod_code" value="<?php echo $prod->prod_code; ?>" class="form-control<?php if (isset($missing_fields) && in_array('prod_code', $missing_fields))
