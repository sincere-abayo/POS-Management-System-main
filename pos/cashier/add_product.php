...
if (isset($_POST['addProduct'])) {
    ...
    if (!empty($missing_fields)) {
        ...
        if (isset($_POST['category']) && $_POST['category'] === 'Other' && !empty($_POST['other_category'])) {
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="other_category" id="other_category_input"
                                            class="form-control mt-2" placeholder="Enter new category"
                                            style="display:none;">
                                    </div>
                                    <div class="col-md-6">
                                        <label>Status</label>
