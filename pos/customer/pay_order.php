...
if (isset($_POST['pay'])) {
  ...
  if (empty($_POST["pay_code"]) || empty($_POST["amount"]) || empty($_POST['pay_method'])) {
    ...
    if (strlen($pay_Code) < 10) {
      ...
      $postQuery = "INSERT INTO rpos_payments (pay_id, pay_code, order_code, customer_id, amount, pay_method) VALUES(?,?,?,?,?,?)";
      ...
      $rc = $postStmt->bind_param('ssssss', $pay_id, $pay_code, $order_code, $customer_id, $amount, $pay_method);
              ...
              <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                  <div class="form-row">
                    ...
                    <div class="col-md-6">
                      <label>Payment Code</label><small class="text-danger"> Type 10 Digits Alpha-Code If Payment Method
                        Is In Cash</small>
                      <input type="text" limit="11" name="pay_code" placeholder="<?php echo $mpesaCode; ?>"
                  ...
                  <div class="form-row">
                    <div class="col-md-6">
                      <label>Amount ($)</label>
                      <input type="text" name="amount" readonly value="<?php echo $total; ?>" class="form-control">
                    </div>
                    <div class="col-md-6">
                      ...
                      <select class="form-control" name="pay_method">
                        ...
                        <option>Airtel Monney</option>
                        <option>MoneGram</option>
