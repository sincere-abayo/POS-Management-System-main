...
// Get all staff and admin for recipient list
$staff_query = "SELECT 'admin' as type, admin_id as id, admin_name as name, admin_email as email FROM rpos_admin 
                UNION 
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body p-0">
                            <div class="list-group list-group-flush" id="recipientsList">
                                <?php while ($recipient = $staff_result->fetch_object()): ?>
    ...
    <script>
        ...
        function displayMessages(messages) {
            ...
            messages.forEach(function (msg) {
                const isOwn = msg.sender_id === '<?php echo $customer_id; ?>' && msg.sender_type === 'customer';
                const messageHtml = `
