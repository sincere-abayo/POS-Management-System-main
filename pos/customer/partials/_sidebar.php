...
<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <a class="navbar-brand pt-0 d-flex align-items-center" href="dashboard.php" style="min-height:60px;">
            <i class="fas fa-shopping-cart" style="font-size:1.8rem;color:#2d3748;margin-right:10px;"></i>
            <span
                style="font-size:1.2rem;font-weight:bold;color:#2d3748;letter-spacing:1px;line-height:1.2;">BRO<br><span
                    style='font-size:1rem;font-weight:400;color:#4a5568;'>Management System</span></span>
        </a>
        <!-- User -->
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="orders.php">
                        <i class="ni ni-cart text-primary"></i>Shop
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="messages.php">
                        <i class="fas fa-comments text-primary"></i> Messages
                    </a>
                </li>
            </ul>
            <!-- Divider -->
